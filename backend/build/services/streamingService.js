...
const cookieService_1 = __importDefault(require("./cookieService"));
class StreamingService {
    ...
    static detectCookieAuth() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const cookieExists = yield cookieService_1.default.cookieFileExists();
                if (cookieExists) {
            ...
            try {
                ...
                if (cookieAuth.success) {
                    if (cookieAuth.method === 'browser') {
                        ...
                        const cookieFilePath = cookieService_1.default.getCookieFilePath();
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (isYouTube) {
                    ...
                    try {
                        return yield this.getVideoInfoWithEnhancedFallback(url);
                    }
                    catch (fallbackError) {
     ...
     */
    static getVideoInfoWithEnhancedFallback(url) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const strategy of fallbackStrategies) {
                try {
                    ...
                    const result = yield strategy.method();
     ...
     */
    static tryWithDifferentUserAgent(url) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                const ytdlpArgs = [
                    '--dump-json',
